...
export default function PrivacyPage() {
  return <LegalPage eyebrow="Your data" title="Privacy Policy" updated="July 15, 2026">
    ...
    <section><h2>Account data</h2><p>If you sign in with Google, we store the basic profile data Google returns to us, such as your email address, display name, avatar URL, locale, the Google account subject identifier, and a login session record. We use this data only to identify your account and keep you signed in.</p></section>
    ...
    <section><h2>Retention</h2><p>We do not provide image history. Closing or resetting the page releases browser preview URLs, and you should download your result before leaving. Account records and login sessions remain in our D1 database until they are deleted, expired, or rotated.</p></section>
